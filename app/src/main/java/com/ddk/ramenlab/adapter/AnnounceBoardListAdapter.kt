...
import com.ddk.ramenlab.data.AnnounceBoardData

class AnnounceBoardListAdapter : RecyclerView.Adapter<AnnounceBoardListAdapter.BoardListViewHolder>() {

    private val dataset = AnnounceBoardData.newBoard
