...
import com.ddk.wineapp.data.RecipeImageData

class RecipeViewPagerAdapter :
    RecyclerView.Adapter<RecipeViewPagerAdapter.RecipeViewPagerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeViewPagerViewHolder {
        val adapterLayout =
            LayoutInflater.from(parent.context).inflate(R.layout.board_read_img_item, parent, false)
