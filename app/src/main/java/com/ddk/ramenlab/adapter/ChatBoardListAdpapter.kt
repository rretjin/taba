...
import com.ddk.ramenlab.data.ChatBoardData

class ChatBoardListAdpapter : RecyclerView.Adapter<ChatBoardListAdpapter.BoardListViewHolder>() {

    private val dataset = ChatBoardData.newBoard
